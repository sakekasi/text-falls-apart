...
/***/ (function(module, exports, __webpack_require__) {
	...
	document.addEventListener('DOMContentLoaded', function () {
	  ...
	  var words = [].concat.apply([], initialText.split('\n').map(function (line) {
	    return line.split(' ');
	  }));
	
	  var randomNext = function randomNext() {
	    var next = '',
	        word = '';
	    var j = 0,
	        i = void 0;
	    while (next === word && ++j < 100) {
	      var prefix = void 0;
	      while (!prefix) {
	        var _chooseSlice = (0, _utils.chooseSlice)(markovChain.prefixLength, words);
	
	        var _chooseSlice2 = _slicedToArray(_chooseSlice, 2);
	
	        prefix = _chooseSlice2[0];
	        i = _chooseSlice2[1];
	      }
	      try {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var MarkovChain = function () {
	  function MarkovChain(text) {
	    var prefixLength = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 2;
...
/***/ (function(module, exports) {
	...
	exports.chooseSlice = chooseSlice;
	...
	function chooseSlice(length, array) {
	  var i = Math.floor(Math.random() * (array.length - length));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var LineBrokenParagraph = function () {
	  function LineBrokenParagraph(parentNode, text) {
	    var _this = this;
	    ...
	    this.words = words = [].concat.apply([], this.text.split('\n').map(function (line) {
	      ...
	      return (0, _utils._)('word', {}, (0, _utils._)('currentWord', {}, (0, _utils.t)(word)));
	    });
	  ...
	  _createClass(LineBrokenParagraph, [{
	    key: "_findWord",
	    value: function _findWord(wordText) {
	      return this.words.find(function (dom) {
	        return dom.textContent === wordText;
	      });
	    }
	  }, {
	    key: "swapWord",
	    value: function swapWord(i, newWord) {
	      var word = this.words[i].firstChild.textContent;
	      var wordDom = this.words[i];
	      var currentWord = wordDom.firstChild;
	      var wordText = currentWord.firstChild;
	
	      var tempWord = (0, _utils._)('wordOverlay', {}, (0, _utils.t)(word));
	      ...
	      (0, _velocityAnimate2.default)(currentWord, { opacity: 1 }, 1000);
	      (0, _velocityAnimate2.default)(tempWord, { opacity: 0 }, 1000, function () {
